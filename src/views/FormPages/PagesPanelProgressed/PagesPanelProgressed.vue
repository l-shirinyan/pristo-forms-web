  ...
  <div class='bg-white dark:bg-dark-header outline outline-gray-100 dark:outline-dark-back outline-2 h-12 z-[5]'>
    <div class='lg:max-w-6xl w-[985px] mx-auto md:overflow-hidden overflow-x-auto'>
      <ul class="stepper lg:max-w-7xl w-[985px] mx-auto" id='stepper' data-mdb-stepper="stepper">
        <li class="stepper-step opacity-25" :class='$route.path.includes("progress_basic") ? "stepper-active" : "" '>
          <div class="stepper-head mt-3">
            <div class='stepper-border border-solid border border-midnight dark:border-dark-open-btn rounded-3xl w-36 h-6 flex'
                 :class='$route.path.includes("progress_basic") ? "" : "sm:flex hidden sm:border border-0"'>
              <div v-if='$route.path.includes("progress_basic")'
            ...
            <div :class='$route.path.includes("progress_basic") ? "hidden" : "sm:hidden"'>
              <div class="stepper-head-icon dark: bg-midnight dark:bg-dark-open-btn"> ✔ </div>
            </div>
          </div>
        </li>
        <li class="stepper-step opacity-25"
            :class='$route.path.includes("progress_details") ? "stepper-active" : ""'>
          <div class="stepper-head mt-3">
            <div class='stepper-border border-solid border border-midnight dark:border-dark-open-btn rounded-3xl w-36 h-6 flex'
                 :class='$route.path.includes("progress_details") ? "" : "sm:flex hidden sm:border border-0"'>
              <div v-if='$route.path.includes("progress_basic") || $route.path.includes("progress_details")'
                   class="stepper-head-icon dark: bg-midnight dark:bg-dark-open-btn"
              >
                2
              </div>
            ...
            <div :class='$route.path.includes("progress_details") ? "hidden" : "sm:hidden"'>
              <div class="stepper-head-icon dark: bg-midnight dark:bg-dark-open-btn"> ✔ </div>
            </div>
          </div>
        </li>
        <li class="stepper-step opacity-25" :class='$route.path.includes("progress_safety") ? "stepper-active" : "" '>
          <div class="stepper-head mt-3">
            <div class='stepper-border border-solid border border-midnight dark:border-dark-open-btn rounded-3xl w-36 h-6 flex'
                 :class='$route.path.includes("progress_safety") ? "" : "sm:flex hidden sm:border border-0"'>
              <div v-if='$route.path.includes("progress_basic") || $route.path.includes("progress_details") || $route.path.includes("progress_safety")'
                   class="stepper-head-icon dark: bg-midnight dark:bg-dark-open-btn"
              >
                3
              </div>
            ...
            <div :class='$route.path.includes("progress_safety") ? "hidden" : "sm:hidden"'>
              <div class="stepper-head-icon dark: bg-midnight dark:bg-dark-open-btn"> ✔ </div>
            </div>
          </div>
        </li>
        <li class="stepper-step opacity-25" :class='$route.path.includes("progress_control") ? "stepper-active" : "" '>
          <div class="stepper-head mt-3">
            <div class='stepper-border border-solid border border-midnight dark:border-dark-open-btn rounded-3xl w-36 h-6 flex'
                 :class='$route.path.includes("progress_control") ? "" : "sm:flex hidden sm:border border-0"'>
            ...
            <div :class='$route.path.includes("progress_control") ? "hidden" : "sm:hidden"'>
              <div class="stepper-head-icon dark: bg-midnight dark:bg-dark-open-btn"> ✔ </div>
            </div>
          </div>
        </li>
      ...
      changeStepPosition: function() {
        if (window.innerWidth > 1024) {
          if (this.$i18n.locale === 'en') {
            ...
            if(this.$route.fullPath === '/inspection_details/progress_basic') {
              element!.style.paddingLeft = '420px'
            }else if(this.$route.fullPath === '/inspection_details/progress_details') {
              element!.style.paddingLeft = '145px'
            }else if(this.$route.fullPath === '/inspection_details/progress_safety') {
              element!.style.right = '125px'
            }else if(this.$route.fullPath === '/inspection_details/progress_control') {
...
<style scoped>
  ...
  .stepper-active .stepper:not(.stepper-vertical) .stepper-step:not(:last-child) .stepper-head[data-v-0b3aa5f6]:after,
  .stepper:not(.stepper-vertical) .stepper-step:not(:first-child) .stepper-head[data-v-0b3aa5f6]:before,
  .stepper:not(.stepper-vertical) .stepper-step:not(:first-child) .stepper-head[data-v-0b3aa5f6]:after,
  .stepper:not(.stepper-vertical) .stepper-step:not(:first-child) .stepper-head[data-v-0b3aa5f6]:before,
  .stepper:not(.stepper-vertical) .stepper-step:not(:last-child) .stepper-head[data-v-0b3aa5f6]:after {
